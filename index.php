...
<body
  ...
  <section class="relative h-[30vh] md:h-[55vh] overflow-hidden flex items-center justify-center border-y border-slate-100" style="background-color: #F0F7FF;">
    ...
    <div class="absolute inset-0 flex flex-col items-center justify-center select-none overflow-hidden pointer-events-none z-10 px-4">
      ...
      <div id="parallax-watermark" class="hidden md:block">
        <div class="flex flex-row items-center justify-center animate-dpc-move"><img src="assets/img/logo.png" alt="DPC Logo" class="h-[28vw] object-contain" style="filter: drop-shadow(0 20px 40px rgba(11, 26, 46, 0.3));" /></div>
      </div>
    </div>
    <div class="absolute inset-0 z-20 pointer-events-none">
      <svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="100%" height="100%" viewBox="0 0 1600 900" preserveAspectRatio="xMidYMax slice" style="position: absolute; top: 0; left: 0; width: 100%; height: 100%; box-sizing: border-box; display: block; background: transparent;">
        ...
        <g>
          <use xlink:href='#wave-fg' opacity=".4">
  ...
  <section class="py-32 bg-transparent relative overflow-hidden" id="nosotros">
    <div class="absolute top-0 inset-x-0 h-48 -mt-1 overflow-hidden pointer-events-none">
      <svg class="absolute top-0 left-0 w-[120%] h-full wave-layer-slow opacity-20 fill-primary" viewBox="0 0 1440 120" preserveAspectRatio="none">
        <path d="M0,32L48,37.3C96,43,192,53,288,58.7C384,64,480,64,576,58.7C672,53,768,43,864,42.7C960,43,1056,53,1152,53.3C1248,53,1344,43,1392,37.3L1440,32V0H1392C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0H0Z"></path>
      </svg>
      <svg class="absolute top-0 left-0 w-[110%] h-full wave-layer opacity-40 fill-[#F0F7FF]" viewBox="0 0 1440 120" preserveAspectRatio="none" style="animation-delay: -2s">
        <path d="M0,64L48,69.3C96,75,192,85,288,80C384,75,480,53,576,48C672,43,768,53,864,64C960,75,1056,85,1152,85.3C1248,85,1344,75,1392,69.3L1440,64V0H1392C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0H0Z"></path>
      </svg>
    </div>
      ...
      <div class="bg-white w-full max-w-3xl mx-4 rounded-[2rem] shadow-2xl relative z-10 transform scale-95 opacity-0 transition-all duration-300 flex flex-col overflow-hidden" id="modalContent">
        ...
        <div class="px-8 md:px-12 py-8 border-b border-slate-100 flex justify-between items-start mt-2">
          <div class="flex items-start gap-5">
            ...
            <div><span class="text-slate-400 text-xs font-bold uppercase tracking-widest mb-1 block">Detalle de Sección</span>
              <h3 class="text-3xl font-black text-dark-navy leading-tight" id="modalTitle">Título Modal</h3>
            </div>
          </div>
        ...
        <div class="px-8 md:px-12 py-10 bg-slate-50/50">
          <p class="text-slate-600 leading-relaxed font-light text-xl" id="modalText">Texto detallado del modal...</p>
        </div>
        ...
        <div class="swiper-wrapper">
          ...
          <div class="swiper-slide !w-[300px] md:!w-[450px]">
            <a href="productos.php?cat=proteccion" class="relative block h-64 md:h-80 rounded-[2rem] overflow-hidden group shadow-2xl border border-white/10">
              <img src="assets/img/catalogo/barbijos.png" alt="Protección Personal" class="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-110" data-i18n-alt="prod_cat_proteccion_title">
              ...
              <div class="absolute inset-0 flex flex-col justify-end p-8 md:p-10">
                <h3 class="text-white text-2xl md:text-3xl font-black uppercase tracking-tight mb-4 drop-shadow-lg leading-none" data-i18n="prod_cat_proteccion_title">Protección Personal</h3>
                <div class="inline-block self-start bg-[#F3B844] text-dark-navy px-8 py-3 rounded-md font-black text-xs uppercase tracking-widest shadow-xl transform transition-all group-hover:scale-105" data-i18n="btn_explore_now">Explorar Ahora</div>
              </div>
            </a>
          </div>
          <!-- 2. Camisolines -->
          <div class="swiper-slide !w-[300px] md:!w-[450px]">
            <a href="productos.php?cat=camisolines" class="relative block h-64 md:h-80 rounded-[2rem] overflow-hidden group shadow-2xl border border-white/10">
              ...
              <div class="absolute inset-0 bg-gradient-to-t from-dark-navy/90 via-dark-navy/20 to-transparent"></div>
              <div class="absolute inset-0 flex flex-col justify-end p-8 md:p-10">
                <h3 class="text-white text-2xl md:text-3xl font-black uppercase tracking-tight mb-4 drop-shadow-lg leading-none" data-i18n="prod_cat_camisolines_title">Camisolines</h3>
                <div class="inline-block self-start bg-[#F3B844] text-dark-navy px-8 py-3 rounded-md font-black text-xs uppercase tracking-widest shadow-xl transform transition-all group-hover:scale-105" data-i18n="btn_explore_now">Explorar Ahora</div>
              </div>
            </a>
          </div>
          ...
          <div class="swiper-slide !w-[300px] md:!w-[450px]">
            <a href="productos.php?cat=quirurgico" class="relative block h-64 md:h-80 rounded-[2rem] overflow-hidden group shadow-2xl border border-white/10">
              ...
              <div class="absolute inset-0 bg-gradient-to-t from-dark-navy/90 via-dark-navy/20 to-transparent"></div>
              <div class="absolute inset-0 flex flex-col justify-end p-8 md:p-10">
                <h3 class="text-white text-2xl md:text-3xl font-black uppercase tracking-tight mb-4 drop-shadow-lg leading-none" data-i18n="prod_cat_quirurgico_title">Línea Quirúrgica</h3>
                <div class="inline-block self-start bg-[#F3B844] text-dark-navy px-8 py-3 rounded-md font-black text-xs uppercase tracking-widest shadow-xl transform transition-all group-hover:scale-105" data-i18n="btn_explore_now">Explorar Ahora</div>
              </div>
            </a>
          </div>
          ...
          <div class="swiper-slide !w-[300px] md:!w-[450px]">
            <a href="productos.php?cat=kit_pacientes" class="relative block h-64 md:h-80 rounded-[2rem] overflow-hidden group shadow-2xl border border-white/10">
              ...
              <div class="absolute inset-0 bg-gradient-to-t from-dark-navy/90 via-dark-navy/20 to-transparent"></div>
              <div class="absolute inset-0 flex flex-col justify-end p-8 md:p-10">
                <h3 class="text-white text-2xl md:text-3xl font-black uppercase tracking-tight mb-4 drop-shadow-lg leading-none" data-i18n="prod_cat_kit_pacientes_title">Kits Pacientes</h3>
                <div class="inline-block self-start bg-[#F3B844] text-dark-navy px-8 py-3 rounded-md font-black text-xs uppercase tracking-widest shadow-xl transform transition-all group-hover:scale-105" data-i18n="btn_explore_now">Explorar Ahora</div>
              </div>
            </a>
          </div>
          ...
          <div class="swiper-slide !w-[300px] md:!w-[450px]">
            <a href="productos.php?cat=cobertores" class="relative block h-64 md:h-80 rounded-[2rem] overflow-hidden group shadow-2xl border border-white/10">
              ...
              <div class="absolute inset-0 bg-gradient-to-t from-dark-navy/90 via-dark-navy/20 to-transparent"></div>
              <div class="absolute inset-0 flex flex-col justify-end p-8 md:p-10">
                <h3 class="text-white text-2xl md:text-3xl font-black uppercase tracking-tight mb-4 drop-shadow-lg leading-none" data-i18n="prod_cat_cobertores_title">Cobertores</h3>
                <div class="inline-block self-start bg-[#F3B844] text-dark-navy px-8 py-3 rounded-md font-black text-xs uppercase tracking-widest shadow-xl transform transition-all group-hover:scale-105" data-i18n="btn_explore_now">Explorar Ahora</div>
              </div>
            </a>
          </div>
          ...
          <div class="swiper-slide !w-[300px] md:!w-[450px]">
            <a href="productos.php?cat=ambos" class="relative block h-64 md:h-80 rounded-[2rem] overflow-hidden group shadow-2xl border border-white/10">
              ...
              <div class="absolute inset-0 bg-gradient-to-t from-dark-navy/90 via-dark-navy/20 to-transparent"></div>
              <div class="absolute inset-0 flex flex-col justify-end p-8 md:p-10">
                <h3 class="text-white text-2xl md:text-3xl font-black uppercase tracking-tight mb-4 drop-shadow-lg leading-none" data-i18n="prod_cat_ambos_title">Ambos</h3>
                <div class="inline-block self-start bg-[#F3B844] text-dark-navy px-8 py-3 rounded-md font-black text-xs uppercase tracking-widest shadow-xl transform transition-all group-hover:scale-105" data-i18n="btn_explore_now">Explorar Ahora</div>
              </div>
            </a>
          </div>
          ...
          <div class="space-y-8">
            <div class="flex gap-6 items-center">
              ...
              <div>
                ...
                <p class="text-lg font-bold text-dark-navy leading-tight">Colombia 2589, San Miguel de Tucumán</p>
              </div>
            </div>
            <div class="flex gap-6 items-center">
              ...
              <div>
                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Email Corporativo</p>
                <p class="text-lg font-bold text-dark-navy leading-tight">e.galvan@pharmacenter.com.ar</p>
              </div>
            </div>
            <div class="flex gap-6 items-center">
              ...
              <div>
                <p class="text-[10px] font-black text-slate-400 uppercase tracking-widest mb-1">Teléfonos</p>
                <p class="text-base font-bold text-dark-navy leading-tight">+54 9 3812 50-5978 / +54 9 3815 51-3883 / +54 9 3812 53-0369</p>
              </div>
            </div>
          </div>
        </div>
  ...
  <a class="fixed bottom-10 right-10 z-[60] w-20 h-20 bg-[#25D366] rounded-full flex items-center justify-center shadow-2xl hover:scale-110 transition-transform group" href="https://wa.me/5493812505978" target="_blank">
  ...
  <script>
    ...
    const modalData = [{
        ...
        titleKey: "home_modal_0_title",
        textKey: "home_modal_0_text"
      },
      {
        icon: "language",
        titleKey: "home_modal_1_title",
        textKey: "home_modal_1_text"
      },
      {
        icon: "workspace_premium",
        titleKey: "home_modal_2_title",
        textKey: "home_modal_2_text"
      },
      {
        icon: "rule",
        titleKey: "home_modal_3_title",
        textKey: "home_modal_3_text"
      }
    ];
